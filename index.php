...
<head>
    <title>EJBI | Selamat Datang</title>
</head>
...
<body>
    ...
    <section class="banner" id="banner">
        <div class="content">
            ...
            <a href="register.php" class="btn btn-home">DAFTAR PENGGUNA</a>
        </div>
    </section>
    ...
    <section class="feedback">
        ...
        <h2 class="titleText">Ada Cadangan? Suarakan Disini</h2>
            ...
            <div class="row">
                    ...
                    <div class="contentBx">
                        <form action="" method="post" enctype="multipart/form-data"> 
                            <div class="form">
                                ...
                                <div class="inputBx">
                                    <input type="text" name="emel" placeholder="Email" value="">
                                </div>
                                <div class="inputBx">
                                    <textarea name="feedback" value="" placeholder="Berikan cadangan/maklumbalas anda"></textarea>
                                </div>
                                <div class="inputBx">
                                    <input type="submit" class="btn btn-home" name="sub" placeholder="" value="Hantar">
                                </div>
                            </div>
                        </form>
                ...
                <div class="col50">
                    <div class="imgBx">
                        <img style="padding: 60px;" src="ico/oku.svg">
                    </div>
                </div>
            </div>
    ...
    <section class="socmed" id="socmed">
        <h2 class="titleText">Ikuti Kami</h2>
        <p class="text">Ikuti kami di media sosial untuk mengikuti perkembangan terkini</p>
        <div class="imgBx">
            <a href="https://www.twitter.com/dccomm_gov/"><img src="ico/twitter.png"></a>
            <a href="https://www.facebook.com/jabatankomunikasikomunitiofficial"><img src="ico/fb.png"></a>
            <a href="https://www.instagram.com/dccomm_gov/"><img src="ico/ig.png"></a>
        </div>
    </section>
