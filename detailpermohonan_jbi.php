    ...
    <section class="container">
        <div class="container-table">
            ...
            $count2 = "SELECT J.* FROM pendaftaranjbi J 
                    JOIN permohonanhantar I on J.nokadpengenalan =  I.icJBI where I.idpermohonan = ?";
            ...
            if($stmt2 = $link->prepare($count2)){
                ...
                <tr><td><b>Nama Jurubahasa</b></td><td><a href=detailJBI_jbi.php>$row2->namapenuh</td></tr>
