    ...
    <div class="container-table">
        ...
        <?Php
            ...
            $count="SELECT P.*, U.filenew1, U.filenew2 FROM pendaftaranjbi P 
                    JOIN uploaded_files_pendaftaran U on P.nokadpengenalan = U.nokad where P.namapenuh= ?";
            ...
            if($stmt = $link->prepare($count)){
                ...
                echo "<thead>
                    ...
                    <tr><td><b>Status MFD</b></td><td>$row->mfdstatus</td></tr>
        ...
        <form method="post" action="javascript:history.go(-1)">
            ...
            <div style="text-align: center;">
                <br>
                <button style="width:10em" class="btn btn-primary" value="Back" name="btnBack">KEMBALI</button>
